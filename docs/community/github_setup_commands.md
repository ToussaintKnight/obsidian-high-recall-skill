...
The original launch critique found almost no human page-view distribution. Repository metadata, topics, labels, discussions, Pages, releases, and social preview are not cosmetic; they help visitors understand whether the project is alive, searchable, and safe to try.
