...
const discussionLinkFiles = [
  ...
  "docs/marketing/community_launch_posts.md",
];
for (const file of discussionLinkFiles) {
...
requireIncludes(
  ...
  [
    ...
    "Reproduces in Codespaces no-vault sandbox?",
...
requireIncludes(
  ...
  [
    ...
    "Codespaces no-vault sandbox passed",
...
requireIncludes("docs/community/starter_issues.md", starterIssues, [
  ...
  "Codespaces No-Vault Fixture Smoke Test",
